...
<body>
    ...
    <div class="small-container">
        ...
        <div class="row  row-3">
            <h2>All Products</h2>
            <div>
        		<a href="add-product" class="addProduct">Add Product</a>
        	</div>
            <select>
	        	...
	        	<c:forEach items="${products}" var="product">
				    ...
				    <a href="product-details">
				        ...
				        <div style="margin-top : 20px">
				        	<a href="update-page?id=${product.id}" class="updateButton">Update</a>
        					<a href="delete-page?id=${product.id}" class="deleteButton">Delete</a>
				        </div>
				    </div>
				</c:forEach>
	        </div>
